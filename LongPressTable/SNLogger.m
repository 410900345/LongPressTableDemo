...
+ (void)load
{
    ...
    fprintf( stderr, "****************************************************************************************\n" );
	fprintf( stderr, "    											   \n" );
	fprintf( stderr, "    	copyright (c) 2016, {JuLong}               \n" );
    fprintf( stderr, "    	https://julong.com                         \n" );
	fprintf( stderr, "    										       \n" );
...
- (NSString *)formatLogMessage:(DDLogMessage *)logMessage
{
    ...
    NSString *timeStr = [NSDate fetchServerTimeForStr:[@([NSDate fetchLongTime])stringValue] type:11];
    NSString *formatStr = [NSString stringWithFormat:@"%@|%@|%@",
                           logLevel, timeStr,logMessage->_message];
    return formatStr;
}
